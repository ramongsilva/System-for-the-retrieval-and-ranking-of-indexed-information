...
<p>  S5 → result of text classification based on ensemble;</p>
  <p>   <strong>Result (output) → list of the PubMed abstracts with extracted information and ranking scores calculated</strong>.</p></i>
   ...
   <h2Algorithm for search of polyphenol-cancer (example of part of the algorithm)</h2>    
  ...
  <li><a href='https://github.com/ramongsilva/System-for-the-retrieval-and-ranking-of-indexed-information/blob/main/functions.R'>functions.R</a>: script with auxiliar functions. Save this file in the same folder of polyphenol_cancer_search_ranking_algorithm_gh.R script, because it is needed to execute this script.</li>
